...
namespace XjjXmm.Infrastructure.ToolKit
{
    public static class EnumKit
    {
        ...
        public static T[] GetEnums<T>() where T : struct, Enum
        {
		...
		public static TEnum Parse<TEnum>(object member)
		{
			...
			return (TEnum)System.Enum.Parse(TypeKit.GetType<TEnum>(), value, true);
		}
		...
		{
			return GetName(TypeKit.GetType<TEnum>(), member);
		}
		...
		{
			return GetValue(TypeKit.GetType<TEnum>(), member);
		}
