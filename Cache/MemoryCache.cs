...
namespace XjjXmm.Infrastructure.Cache
{
    /// <summary>
    /// 本地缓存
    /// </summary>
    public class XjjxmmMemoryCache : ICache
    {
        ...
        public bool Set(string key, object value)
        {
            ...
            Set(key, value, TimeSpan.FromDays(1), true);
        ...
        {
            return Keys().FirstOrDefault(t => t == key) != null;
        }
        ...
        /// <returns></returns>
        private IDictionary<string, object> GetAll(IEnumerable<string> keys)
        {
            if (keys == null)
                throw new ArgumentNullException(nameof(keys));
