    ...
    public class JwtHelper
    {
        ...
        public static string IssueToken(JwtTokenSetting jwtConfig, TokenModelOptions options)
        {
            ...
            var claims = new List<Claim>
            {
               ...
               new Claim(ClaimTypes.NameIdentifier, options.Id),
			...
			if(!options.IsAccess)
			{
				claims.Add(new Claim("IsAccess", "0"));
			}
        ...
        public static string IssueRefreshToken(JwtTokenSetting jwtConfig)
        {
            var expires = jwtConfig.GetExpires();
        ...
        public static TokenModelOptions? DecryptToken(string jwtStr)
        {
            ...
            try
            {
                ...
                {
                    Id = jwtToken.Claims.FirstOrDefault(t => t.Type == ClaimTypes.NameIdentifier)?.Value ?? "",
